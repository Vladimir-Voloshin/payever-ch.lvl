...
},{"backbone":4,"backbone.babysitter":1,"backbone.wreqr":3,"underscore":6}],3:[function(require,module,exports){
...
module.exports = {
  BASE_URL: 'http://pe-ch.localhost',
  HEADERS: {
    Accept: 'application/json'
  },
  ALBUMS_LIST_DATA_URL: '/albums/',
  IMAGES_LIST_DATA_URL: '/album/'
};


},{}],8:[function(require,module,exports){
var Backbone, dispatcher;

Backbone = require("backbone");

dispatcher = require("./appDispatcher.coffee");

dispatcher.on('showAlbumImages', function(options) {
  return Backbone.history.navigate('/album/' + options.albumId + '/page/' + options.page, {
    trigger: true
  });
});
...
},{"./appDispatcher.coffee":9,"backbone":4}],9:[function(require,module,exports){
var Wreqr, appDispatcher;
...
},{"backbone.wreqr":3}],10:[function(require,module,exports){
var Mn, RootView;
...
},{"backbone.marionette":2}],11:[function(require,module,exports){
var layout, mainView, run;
...
run = function() {
  ...
  return layout.getRegion('menu').show(mainDataView);
};
...
},{"./../../appLayout.coffee":10,"./views/mainView.coffee":14}],12:[function(require,module,exports){
var Backbone, albums, albumsCollection, appConstants;
...
},{"backbone.marionette":2,"underscore":6}],14:[function(require,module,exports){
var AlbumsCollection, Mn, albumRaw, dispatcher, mainView;
...
mainView = Mn.CollectionView.extend({
  ...
  onChildviewSelectEntry: function(child, options) {
    return dispatcher.trigger('showAlbumImages', {
      'albumId': child.model.attributes.id,
      'page': 1
    });
  }
});
...
},{"./../../../appDispatcher/appDispatcher.coffee":9,"./../collections/albumsCollection.coffee":12,"./albumRowView.coffee":13,"backbone.marionette":2}],15:[function(require,module,exports){
var ImagesCollection, appConstants, layout, mainView, run;
...
},{"./../../appConstants.coffee":7,"./../../appLayout.coffee":10,"./collections/imagesCollection.coffee":16,"./views/mainView.coffee":21}],16:[function(require,module,exports){
var Backbone, imagesCollection;
...
var ImagesCollection, Mn, imageRow, itemsList;
...
navigationPanel = Mn.ItemView.extend({
  ...
  scrollBack: function() {
    ...
    return dispatcher.trigger('showAlbumImages', {
      'albumId': this.options.albumId,
      'page': parseInt(this.options.currentPage) - 1
    });
  },
...
},{"./../../../appDispatcher/appDispatcher.coffee":9,"./../templates/navigationPanelView.coffee":18,"backbone.marionette":2,"underscore":6}],23:[function(require,module,exports){
var Backbone, Mn, payever, payeverApp, router;
...
payeverApp.addInitializer(function() {
  Backbone.history.start();
  require('./pages/albums/app.coffee').run();
  return require('./appDispatcher/actionsRegister.coffee');
});

payeverApp.start({});


},{"./appDispatcher/actionsRegister.coffee":8,"./pages/albums/app.coffee":11,"./router.coffee":24,"backbone":4,"backbone.marionette":2}],24:[function(require,module,exports){
var Mn, router;
...
router = Mn.AppRouter.extend({
  ...
  controller: {
    albums: function() {
      return require('./pages/albums/app.coffee').run();
    },
    albumImages: function(albumId) {
      return require('./pages/images/app.coffee').run(albumId);
    },
    albumImagesPaged: function(albumId, page) {
      return require('./pages/images/app.coffee').run(albumId, page);
    }
  }
});
...
},{"./pages/albums/app.coffee":11,"./pages/images/app.coffee":15,"backbone.marionette":2}]},{},[23]);
